...
姉妹プロジェクト basho の `docs/adr/001-test-strategy-and-tdd.md` と同じく、t-wada 流のテストサイズ戦略と Kent Beck の TDD (Red-Green-Refactor) を採用する。ただし basho と異なり、uni では実外部サイトの構造変化を検知する価値があるため、Large を完全には捨てず、PR ブロッキングではなく監視用途に限定して運用する。
...
1. basho `docs/adr/001-test-strategy-and-tdd.md`
2. [t-wada テストサイズの考え方](https://levtech.jp/media/article/column/detail_496/)
